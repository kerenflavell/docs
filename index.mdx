...
<CardGroup cols={2}>
  <Card title="Building Your Team" icon="palette" href="https://mintlify.com/docs/settings/global">
    Customize your docs to your company's colors and brands
  </Card>
  <Card title="Setting Up Your Workflow" icon="code" href="https://mintlify.com/docs/api-playground/openapi">
